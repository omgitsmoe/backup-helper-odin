...
hash_file :: proc(t: ^testing.T) {
    ...
    tests := []struct{ ht: ch.Hash_Type, expected: string }{
        ...
        { .Sha2_384, "59e1748777448c69de6b800d7a33bbfb9ff1b463e44354c3553bcdb9c666fa90125a3c79f90397bdf5f6a13de828684f" },
        { .Sha2_512, "9b71d224bd62f3785d96d46ad3ea3d73319bfbc2890caadae2dff72519673ca72323c3d99ba5c11d7c7acc6e14b8c5da0c4663475c2e5c3adef46f73bcdec043" },
    ...
    for tt in tests {
        ...
        testing.expectf(t, hex_str == tt.expected,
            "hash_file(%v): expected %q, got %q", tt.ht, tt.expected, hex_str)
...
hash_file_handle :: proc(t: ^testing.T) {
    ...
    for tt in tests {
        ...
        testing.expectf(t, hex_str == tt.expected,
            "hash_file_handle(%v): expected %q, got %q", tt.ht, tt.expected, hex_str)
...
hash_file_empty :: proc(t: ^testing.T) {
    ...
    testing.expectf(t, hex_str == "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "hash_file empty: expected %q, got %q", "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", hex_str)
...
hash_file_callback :: proc(t: ^testing.T) {
    ...
    Callback_Data :: struct{ read: u64, total: u64 }
    actual_callbacks: [dynamic]Callback_Data
    digest, ok := ch.hash_file(.Md5, path, 1337, proc(read: u64, total: u64, userdata: rawptr) -> bool {
    ...
    testing.expectf(t, hex_str == expected_hash,
        "hash_file(%v): expected %q, got %q", ch.Hash_Type.Md5, expected_hash, hex_str)
    testing.expect(
        t,
        slice.equal(
            []Callback_Data{
