...
collection_files_iter :: proc(t: ^testing.T) {
    ...
    testing.expectf(t, found[apath].size == 100, "a.txt: expected size 100, got %v", found[apath].size)
    testing.expectf(t, found[bpath].size == 200, "b.txt: expected size 200, got %v", found[bpath].size)
    testing.expectf(t, found[cpath].size == 300, "c.txt: expected size 300, got %v", found[cpath].size)
